			...
			<div className='md:py-16 prose m-auto'>
				...
				<FadeIn className='ind cont flex flex-col gap-4 text-[15px] md:text-base leading-relaxed'>
					<section>
						...
						<p>
							Добрый день. Сегодня мы разберём ключевые дефекты характера,
							которые мешают нам строить гармоничные отношения, достигать целей
							...
							<ul className='list-disc ml-6'>
								...
								<li>
									...
									<ul className='list-[circle] ml-6'>
										...
										<li>
											Перфекционизм ("Если не идеально - зачем начинать?")
										</li>
									</ul>
								</li>
							</ul>
					...
					<section>
						...
						<ul className='list-disc ml-6'>
							...
							<li>
								→ Автоматические защитные реакции вместо осознанных решений
							</li>
						</ul>
					</section>
					...
					<section>
						...
						<p>
							Когда мы осознаём страх в основе дефекта, он теряет власть над
							нами.
						</p>
						<hr className='my-4' />
						<p className='italic'>

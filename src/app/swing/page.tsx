			...
			<FadeIn className='ind cont flex flex-col gap-6 md:gap-8 text-[15px] md:text-base leading-relaxed'>
				...
				<section>
					...
					<div className='mb-4'>
						...
						<ul className='list-disc ml-6'>
							<li>
								<b>Динамика:</b> Гнев → энергия для защиты границ. Стыд → сигнал
								о предательстве себя.
							</li>
							<li>
				...
				<section>
					...
					<ul className='list-disc ml-6 mb-2'>
						...
						<li>
							<b>Обвал:</b> Решения <i>слишком осторожные</i> → жизнь «в режиме
							ожидания».
						</li>
						<li>
				...
				<section>
					...
					<ol className='list-decimal ml-6 mb-2'>
						<li>
							<b>СКОЛЬКО ЛЕТ ВЫ КОРМИТЕ СВОИХ ВНУТРЕННИХ ДЕМОНОВ МОЛЧАНИЕМ?</b>
						</li>
						<li>
							<b>
								ВАШИ КАЧЕЛИ — ЭТО БЕЗУМИЕ ИЛИ ЕДИНСТВЕННЫЙ СПОСОБ ОСТАТЬСЯ ЖИВЫМ
								В МЕРТВОМ МИРЕ?
							</b>
						</li>
						<li>
				...
				<section>
					...
					<ul className='list-disc ml-6 mb-2'>
						...
						<li>
							<b>Франкл:</b> Экстремальные состояния как <i>дорога к смыслу</i>.
						</li>
					</ul>
					<p className='mb-2'>
